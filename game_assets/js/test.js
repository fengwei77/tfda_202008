...
const tiling = new PIXI.projection.TilingSprite2d(PIXI.Texture.from('https://pixijs.io/examples/examples/assets/bg_plane.jpg'), app.screen.width, app.screen.height);
tiling.position.set(app.screen.width / 2, app.screen.height);
tiling.anchor.set(0.5, 1.0);
tiling.tint = 0x808080;

const surface = new PIXI.projection.Sprite2d(PIXI.Texture.from('https://pixijs.io/examples/examples/assets/bg_plane.jpg'));
...
const bunny = new PIXI.projection.Sprite2d(PIXI.Texture.from('https://pixijs.io/examples/assets/flowerTop.png'));
