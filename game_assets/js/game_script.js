...
function onAssetsLoaded(loaderInstance, res) {
    ...
    player_container.addChild(bg_sprite);
    ...
    player_container.addChild(textureArray['shiba_cry']);
    app.stage.addChild(player_container);
    ...
    player_container.addChild(textureArray['shiba_succes']);
    ...
    player_container.addChild(textureArray['shiba_thank']);
    app.stage.addChild(player_container);
    ...
    player_container.scale.set(ratio, ratio);
    app.renderer.resize(1366 * ratio, 600 * ratio);
